...
import useDeletePaymentProperty from "@/hooks/api/mutation/project/property/useDeletePaymentProperty";
...
const DeletePayPropsModal = ({
  ...
  const { mutate: DeleteAction, isPending } = useDeletePaymentProperty();
